...
<div <%= portletTitleBasedNavigation ? "class=\"closed container container-no-gutters-sm-down container-view sidenav-container sidenav-right\" id=\"" + liferayPortletResponse.getNamespace() + "infoPanelId\"" : StringPool.BLANK %>>
	<c:if test="<%= portletTitleBasedNavigation %>">
