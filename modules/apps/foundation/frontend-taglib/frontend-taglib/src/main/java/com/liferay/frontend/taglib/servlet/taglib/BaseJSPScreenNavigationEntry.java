 ...
 */
public abstract class BaseJSPScreenNavigationEntry<T>
	implements ScreenNavigationEntry<T> {
	...
	public void render(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			_log.error("Unable to render JSP " + getJspPath(), se);
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BaseJSPScreenNavigationEntry.class);
